...
@Entity
@Table(schema = "FINDATA", name="REPRECONINVISSVSSTATEMENT")
@Cacheable(false)
@NamedQueries({
	@NamedQuery(name = "RepreconInvIssVsStatementEntity.findAll", query = "select b from RepreconInvIssVsStatementEntity b"),
	@NamedQuery(name = "RepreconInvIssVsStatementEntity.findTotal", query = "select count(b.id) from RepreconInvIssVsStatementEntity b") })
	

public class RepreconInvIssVsStatementEntity extends BaseEntity {
	...
	public RepreconInvIssVsStatementEntity() {
	...
	public String toString() {
		return "RepreconInvIssVsStatementEntity [id=" + id + ", matchType=" + matchType + ", stmtReference="
	...
	public String getMessage() {
		return "reports reconciliation credit transactions vs issued invoices";
	}
}
