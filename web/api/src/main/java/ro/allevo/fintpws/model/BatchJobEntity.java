...
@NamedQueries({
		@NamedQuery(name = "BatchJobEntity.findById", query = "SELECT r FROM BatchJobEntity r "
...
public class BatchJobEntity extends BaseEntity {
	...
	public String toString() {
		return "BatchJobEntity [combatchid=" + combatchid + ", batchamount=" + batchamount + ", batchcount="
				+ batchcount + ", batchid=" + batchid + ", batchstatus=" + batchstatus + ", batchtype=" + batchtype
				+ ", batchuid=" + batchuid + ", combatchamt=" + combatchamt + ", defjobcount=" + defjobcount
				+ ", insertdate=" + insertdate + ", reason=" + reason + ", routingpoint=" + routingpoint + ", userid="
				+ userid + "]";
	}
