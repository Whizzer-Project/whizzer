...
@NamedQueries({
		@NamedQuery(name = "ServicePerformanceEntity.findById", query = "SELECT t FROM ServicePerformanceEntity t "
...
@Cacheable(false)
public class ServicePerformanceEntity extends BaseEntity {
