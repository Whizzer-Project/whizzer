...
public final class JsonResponseWrapper {
	...
	public static Response getResponse(Response.Status code) {
	...
	public static ObjectNode getEntity(int code, String message, URI uri, String id)
		...
		return mapper.createObjectNode().put("code", code).put("message", finalMessage)
				.put("id", id)
				.put("uri", finalURIPath);
	}

	public static ObjectNode getEntity(Response.Status code, String message,
		...
		return mapper.createObjectNode().put("code", code.getStatusCode())
