 ...
 * 
 */
public class BatchRequestResource extends BaseResource<BatchRequestEntity> {
	/**
	 * Field logger.
	 */
	 ...
	 *            EntityManager
	 */
	public BatchRequestResource(UriInfo uriInfo, EntityManager entityManagerData, String groupKey) {
		super(BatchRequestEntity.class, uriInfo, entityManagerData, groupKey);
	...
	public Response getBatchRequest() {
		try {
			return asJson(groupKey, batchRequestEntities, getUriInfo().getPath(),
					getEntityManager());
	...
	public static Response asJson(String groupKey,
		...
		return Response.status(Response.Status.CREATED).entity(requestAsJson).build();
		//return null;
	}
