...
public class UserRolesJoinResource extends PagedCollection<UserRoleEntity>{
	...
	public UserRolesJoinResource(UriInfo uriInfo, EntityManager entityManagerConfig, 
