...
public class Queue {
	...
	private List<Integer> queueMoveMaps;
	
	private List<QueueMoveMaps> queueMoveMapsEntity;
	...
	public List<QueueMoveMaps> getQueueMoveMapsEntity() {
		return queueMoveMapsEntity;
	}
	public void setQueueMoveMapsEntity(List<QueueMoveMaps> queueMoveMapsEntity) {
		this.queueMoveMapsEntity = queueMoveMapsEntity;
	}
	public List<Integer> getQueueMoveMaps() {
		return queueMoveMaps;
	}
	public void setQueueMoveMaps(List<Integer> queueMoveMaps) {
		this.queueMoveMaps = queueMoveMaps;
	}
	@JsonGetter("rowid")
