...
import ro.allevo.fintpui.dao.UserRolesEntityMapsDao;
...
public class UserService {
	...
	@Autowired
	private UserRolesEntityMapsDao userRolesEntityMapsDao;
	...
	public UserRole[] getUserRolesByUserDefined(Integer userId, LinkedHashMap<String, List<String>> params) {
		return userRoleDao.getRolesByUserDefined(userId, params);
	}
	...
	public UserRolesEntityMaps[] getUserRolesEntityMaps(String userName) {
		return userRolesEntityMapsDao.getUserRolesEntityMaps(userName, null);
	}
	
	public UserRolesEntityMaps[] getUserRolesEntityMaps(String userName, LinkedHashMap<String, List<String>> params) {
		return userRolesEntityMapsDao.getUserRolesEntityMaps(userName, params);
	}
	
	
	public void insertUserRolesEntityMaps(String userName, List<UserRolesEntityMaps> userRolesEntityMaps) {
		userRolesEntityMapsDao.insertUserRolesEntityMaps(userName, userRolesEntityMaps);
	}

	public void deleteUserRolesEntityMaps(String userName) {
		userRolesEntityMapsDao.deleteUserRolesEntityMaps(userName);
