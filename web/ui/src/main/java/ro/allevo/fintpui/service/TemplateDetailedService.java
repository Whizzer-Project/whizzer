...
//	}
	...
	public ResponseEntity<String> insertListOfTemplateDetailed(List<TemplateDetailed> listTemplateDetailed) {
		return templateDetailedDao.insertListTemplateDetailed(listTemplateDetailed);
	}
