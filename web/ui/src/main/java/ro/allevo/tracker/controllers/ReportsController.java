...
public class ReportsController {
	...
	public String overallReport(OAuth2Authentication auth) {
		if (!Roles.hasRoles(auth, Roles.TRACKER_VIEW))
	...
	public String componentReport(OAuth2Authentication auth, ModelMap model) {
		if (!Roles.hasRoles(auth, Roles.TRACKER_VIEW))
			throw new NotAuthorizedException();
	...
	public String liveReport(OAuth2Authentication auth, ModelMap model){
